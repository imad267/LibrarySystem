...
public class NewStudent extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        stu.Student_ID=jTextField1.getText();
        stu.Name = jTextField2.getText();
        stu.Surname= jTextField3.getText();
        stu.Course = (String) jComboBox1.getSelectedItem();
        stu.Branch=jTextField4.getText();
        stu.Year=(String) jComboBox2.getSelectedItem();
        stu.Semester = (String) jComboBox3.getSelectedItem();
        stu.Create();
